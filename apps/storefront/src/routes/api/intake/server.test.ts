...
const good = { kind: 'contact', name: 'Alex', email: 'alex@example.com', message: 'I would like a bot please.', website: '' };
...
describe('POST /api/intake', () => {
	it('relays a valid submission to the intake webhook', async () => {
		...
		expect(JSON.stringify(embed)).toContain('alex@example.com');
	});
